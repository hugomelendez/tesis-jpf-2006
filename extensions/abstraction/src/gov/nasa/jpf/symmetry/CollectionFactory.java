...
public abstract class CollectionFactory {
  ...
  public static SymThreadSet newSymThreadSet() {
    return deflt.createSymThreadSet();
  }
  ...
  abstract SymThreadSet createSymThreadSet();
  ...
  static class CanonicalFactory extends CollectionFactory {
    ...
    public SymThreadSet createSymThreadSet () {
      return new CanonicalThreadSet();
    }
  }
