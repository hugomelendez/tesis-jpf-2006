...
public class ObjectFieldsAbstractor extends FieldsMeta
implements IObjectAbstractor<InstanceObject> {
  public ObjectFieldsAbstractor(FieldsMetaBuilder builder) {
    super(builder);
  }
