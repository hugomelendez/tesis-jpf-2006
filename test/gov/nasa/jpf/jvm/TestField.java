 ...
 * DOCUMENT ME!
 */
public class TestField extends TestFieldBase {
    ...
    if (args.length > 0) {
      ...
      for (int i = 0; i < args.length; i++) {
        ...
        if ("testReadInstance".equals(func)) {
          t.testReadInstance();
        } else if ("testWriteInstance".equals(func)) {
          t.testWriteInstance();
        } else if ("testReadStatic".equals(func)) {
          t.testReadStatic();
        } else if ("testWriteStatic".equals(func)) {
          t.testWriteStatic();
        } else {
