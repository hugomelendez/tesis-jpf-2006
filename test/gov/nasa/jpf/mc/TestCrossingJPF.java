...
public class TestCrossingJPF extends TestJPF {
   ...
   */
  @Test
  public void xxxtestCrossingBFSHeuristic () {
    String[] args = {  "+search.class=gov.nasa.jpf.search.heuristic.HeuristicSearch",
        "+search.heuristic.class=gov.nasa.jpf.search.heuristic.BFSHeuristic", TEST_CLASS };
