...
public class Types {
  ...
  public static String getJNIMangledMethodName (Method m) {
    ...
    StringBuffer   s = new StringBuffer(name.length() + (pt.length * 16));
  ...
  public static String getJNIMangledMethodName (String cls, String name,
                                                String signature) {
    StringBuffer s = new StringBuffer(signature.length() + 10);
    int          i;
    char         c;
  ...
  public static int getNumberOfStackSlots (String signature) {
    int n = 0;
